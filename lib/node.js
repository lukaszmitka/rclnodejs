...
class Node {
  ...
  createActionClient(typeClass, action, options, status_callback, feedback_callback) {
    if (typeof (typeClass) === 'string' || typeof (typeClass) === 'object') {
    ...
    let actionClient = ActionClient.createActionClient(this.handle, typeClass, action, options, status_callback, feedback_callback);
